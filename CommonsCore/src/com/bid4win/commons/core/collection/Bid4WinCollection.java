       ...
       implements Collection<OBJECT>, Cloneable, Serializable
{
   ...
   * sur celui-ci se répercuterons sur la collection et inversement
   * @return {@inheritDoc}
   ...
   * remplie avec les éléments de la collection en argument
   * @param collection Collection avec les éléments de laquelle remplir la nouvelle
   * instance
   ...
   * échoue (par de constructeur basé sur une collection par exemple)
   */
  ...
  /**
   * Défini le clonage d'une collection
   * @return {@inheritDoc}
