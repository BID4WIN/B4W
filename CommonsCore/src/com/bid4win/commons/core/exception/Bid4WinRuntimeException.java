...
/**
 * Cette classe défini la classe de base d'exception système du projet BID4WIN<BR>
 * <BR>
 * @author Emeric Fillâtre
 */
public class Bid4WinRuntimeException extends RuntimeException
{
  /** Determine si un objet dé-sérialisé est compatible avec cette classe. La
   * valeur doit être modifiée si une évolution de la classe la rend incompatible
   * avec les versions précédentes */
  private static final long serialVersionUID = -1426951272983496186L;

  /**
   * Constructeur par défaut
   */
  public Bid4WinRuntimeException()
  {
    this("NO MESSAGE");
  }
