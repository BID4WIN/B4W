...
/**
 * Cette classe précise la gestion automatique des identifiants des entités uniques
...
public class AccountBasedEntitySingleAutoID<CLASS extends AccountBasedEntitySingleAutoID<CLASS, ACCOUNT>,
                                            ACCOUNT extends AccountAbstract<ACCOUNT>>
       extends AccountBasedEntitySingle<CLASS, Long, ACCOUNT>
{
  /**
   * Constructeur pour création par introspection
   */
  protected AccountBasedEntitySingleAutoID()
  {
    super();
  }
  /**
   ...
   */
  protected AccountBasedEntitySingleAutoID(ACCOUNT account) throws UserException
  {
    super(account);
  }
