       ...
       extends AccountBasedEntityMultipleGeneratedID<CLASS, ACCOUNT>
{
  ...
  /** Flag temporaire indiquant la validité de la connexion */
  @Transient
   ...
   * sont état de rémanence. Si la connexion était active, son historique est préparé
   * @param disconnectionReason Raison de fin de connexion
   * @return Retourne la connexion terminée
  ...
  /**
   * Cette fonction permet d'arrêter la connexion courante en retirant sont état
   * de rémanence. Si la connexion était active, son historique est préparé
   * @return Retourne la connexion arrêtée
   * @param disconnectionReason Raison de fin de connexion
   * @throws ProtectionException Si la connexion courante est protégée
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Getter du flag temporaire indiquant la validité de la connexion
   * @return Le flag temporaire indiquant la validité de la connexion
   */
  ...
  /**
   * Cette fonction permet de d'invalider la connexion courante, c'est à dire de
   * la terminer, de stopper toute rémanence et de la noter comme invalide. Si la
   * connexion était active, son historique est préparé
   * @param disconnectionReason Raison de fin de connexion
   * @return Retourne la connexion invalidée
   * @throws ProtectionException Si la connexion courante est protégée
   */
  @SuppressWarnings("unchecked")
