...
public class FooCachedParent1 extends FooCachedParent<FooCachedParent1, FooCachedChild1>
{
  ...
  private Map<String, FooCachedChild1> childMap;

  /**
   * Constructeur
   */
  protected FooCachedParent1()
  {
    super();
  }
   ...
   */
  public FooCachedParent1(String value, Bid4WinDate date)
  {
    super(value, date);
  }
...
/*  @Override
  ...
  // A partir d'Hibernate 4.1.1, l'entité parent n'est pas mise à jour par défaut
  @OptimisticLock(excluded = false)
  protected Map<String, FooCachedChild1> getChildMap()
  {
