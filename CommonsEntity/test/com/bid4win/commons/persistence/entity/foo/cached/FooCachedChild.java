...
public class FooCachedChild<CLASS extends FooCachedChild<CLASS, PARENT>,
                            PARENT extends FooCachedParent<PARENT, CLASS>>
        extends Bid4WinEntity<CLASS, String>
{
   ...
   */
  public FooCachedChild(String id, String value)
  {
    super(id);
    this.setValue(value);
  ...
  {
    return new Bid4WinList<Bid4WinRelationNode>(FooCachedChild_Relations.NODE_PARENT);
  }
  /**
   *
   * TODO A COMMENTER
  ...
  {
    if(relation.equals(FooCachedChild_Relations.RELATION_PARENT))
    {
