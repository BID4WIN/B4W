...
@DiscriminatorValue("CACHED_PARENT")
public class FooCachedParent<CLASS extends FooCachedParent<CLASS, CHILD>,
                             CHILD extends FooCachedChild<CHILD, CLASS>>
       extends FooCached<CLASS>
{
   ...
   */
  protected FooCachedParent(String value, Bid4WinDate date)
  {
    super(value, date);
  }
  ...
  {
    return new Bid4WinList<Bid4WinRelationNode>(FooCachedParent_Relations.NODE_CHILD);
  }
  /**
   *
   * TODO A COMMENTER
