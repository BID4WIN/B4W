...
/**
 * Classe de test du package com.bid4win.manager.locale.inner.store seulement<BR>
 * <BR>
 * @author Emeric Fillâtre
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({com.bid4win.manager.locale.inner.store.InnerContentRepositoryTest.class,
                     com.bid4win.manager.locale.inner.store.InnerContentUsageStoreTest.class})
