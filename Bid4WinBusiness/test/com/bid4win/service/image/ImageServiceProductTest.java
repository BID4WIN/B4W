...
public class ImageServiceProductTest extends ImageServiceTester
{
  /** TODO A COMMENTER */
  @Autowired
  @Qualifier("ImageServiceProductStub")
  private ImageServiceProductStub service;
  /** Référence TODO */
  @Autowired
  ...
  protected void validateProduct(int version, int updateForce) throws Bid4WinException
  {
    ...
    Bid4WinList<ImageUsage> list = this.getUsageDao().findAll();
    list.sort();
    assertEquals("Wrong image lists", list, product.getImageList());
  }
   ...
   */
  @Override
  public ImageServiceProductStub getService()
  {
    return this.service;
  }
