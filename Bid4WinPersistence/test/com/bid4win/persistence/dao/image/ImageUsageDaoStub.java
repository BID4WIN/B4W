 ...
 */
@Component("ImageUsageDaoStub")
@Scope("singleton")
@Transactional(readOnly = true, rollbackFor = {Bid4WinException.class})
public class ImageUsageDaoStub extends ImageUsageDao
       implements IResourceDaoStub<ImageUsage, ImageType>
{
  /** TODO A COMMENTER */
  private Bid4WinList<Bid4WinRelationNode> nodeList = new Bid4WinList<Bid4WinRelationNode>();
  {
    try
    {
      ...
      node = ImageUsage_Relations.NODE_PRODUCT.clone();
      node.addNode(Product_Relations.NODE_IMAGE_USAGE_LIST.clone());
      this.nodeList.add(node);
    }
   ...
   */
  @Override
  public ImageUsage getById(Long id) throws PersistenceException
  {
   ...
   */
  @Override
  public ImageUsage getOneByFullPath(String fullPath) throws PersistenceException, UserException
  {
   ...
   */
  @Override
  public ImageUsage findOneByFullPath(String fullPath) throws PersistenceException, UserException
  {
   ...
   */
  @Override
  public Bid4WinList<ImageUsage> findAll() throws PersistenceException
  {
  ...
  public ImageUsage add(ImageUsage root) throws PersistenceException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public ImageUsage update(ImageUsage root) throws PersistenceException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public ImageUsage remove(ImageUsage root) throws PersistenceException
  {
   ...
   */
  @Override
  public ImageUsage findById(Long id) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinMap<Long, ImageUsage> getById(Bid4WinSet<Long> idSet)
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public ImageUsage removeById(Long id) throws PersistenceException, NotFoundEntityException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public Bid4WinSet<ImageUsage> removeListById(Bid4WinSet<Long> idSet)
         throws PersistenceException, NotFoundEntityException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public Bid4WinList<ImageUsage> removeAll() throws PersistenceException
  {
  ...
  private ImageStorageDaoStub storageDao;
  /**
   *
   * TODO A COMMENTER
   * @return {@inheritDoc}
   ...
   */
  @Override
  public ImageStorageDaoStub getStorageDao()
  {
