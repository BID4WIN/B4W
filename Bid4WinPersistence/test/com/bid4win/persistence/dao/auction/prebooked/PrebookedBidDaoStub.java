 ...
 */
@Component("PrebookedBidDaoStub")
@Scope("singleton")
@Transactional(readOnly = true, rollbackFor = {Bid4WinException.class})
public class PrebookedBidDaoStub extends PrebookedBidDao
       implements IBidDaoStub<PrebookedBid, PrebookedAuction, PrebookedBidHistory>
{
  /** Référence du DAO des historiques d'enchères avec pré-inscription */
  @Autowired
  @Qualifier("PrebookedBidHistoryDaoStub")
  private PrebookedBidHistoryDaoStub historyDao;
   ...
   */
  @Override
  public PrebookedBid findOneByAccountId(String accountId) throws PersistenceException
  {
   ...
   */
  @Override
  public PrebookedBid findOneByAccount(Account account) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinList<PrebookedBid> findListByAccountId(String accountId) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinList<PrebookedBid> findListByAccount(Account account) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinList<PrebookedBid> findListByAuctionId(String auctionId) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinList<PrebookedBid> findListByAuction(PrebookedAuction auction) throws PersistenceException
  {
  ...
  public PrebookedBid add(PrebookedBid bid) throws PersistenceException
  {
   ...
   */
  @Override
  public PrebookedBid getById(Long id) throws PersistenceException, NotFoundEntityException
  {
   ...
   */
  @Override
  public PrebookedBid findById(Long id) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinMap<Long, PrebookedBid> getById(Bid4WinSet<Long> idSet)
   ...
   */
  @Override
  public Bid4WinList<PrebookedBid> findAll() throws PersistenceException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public PrebookedBid update(PrebookedBid bid) throws PersistenceException
  {
  ...
  public PrebookedBid removeById(Long id) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinSet<PrebookedBid> removeListById(Bid4WinSet<Long> idSet)
         throws PersistenceException, NotFoundEntityException
  {
   ...
   */
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public Bid4WinSet<PrebookedBid> removeListByAccount(Account account)
         throws PersistenceException, NotFoundEntityException
  {
    Bid4WinSet<PrebookedBid> result = new Bid4WinSet<PrebookedBid>(this.findListByAccount(account));
    for(PrebookedBid bid : result)
    {
   ...
   */
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public Bid4WinSet<PrebookedBid> removeListByAuction(PrebookedAuction auction)
         throws PersistenceException, NotFoundEntityException
  {
    Bid4WinSet<PrebookedBid> result = new Bid4WinSet<PrebookedBid>(this.findListByAuction(auction));
    for(PrebookedBid bid : result)
    {
      result.add(this.remove(bid));
    }
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public PrebookedBid remove(PrebookedBid bid) throws PersistenceException
  {
  ...
  @Override
  @Transactional(readOnly = false)
  public Bid4WinList<PrebookedBid> removeAll() throws PersistenceException
  {
   ...
   * TODO A COMMENTER
   * @return {@inheritDoc}
   * @see com.bid4win.persistence.dao.auction.prebooked.PrebookedBidDao#getHistoryDao()
   */
  @Override
  protected PrebookedBidHistoryDaoStub getHistoryDao()
  {
