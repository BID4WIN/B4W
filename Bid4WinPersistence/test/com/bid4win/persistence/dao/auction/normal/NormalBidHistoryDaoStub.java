 ...
 */
@Component("NormalBidHistoryDaoStub")
@Scope("singleton")
@Transactional(readOnly = true, rollbackFor = {Bid4WinException.class})
public class NormalBidHistoryDaoStub extends NormalBidHistoryDao
       implements IBidAbstractDaoStub<NormalBidHistory, NormalAuction, NormalBidHistory>
{
  /////////////////////////////////////////////////////////////////////////////
   ...
   */
  @Override
  public NormalBidHistory findOneByAccountId(String accountId) throws PersistenceException
  {
   ...
   */
  @Override
  public NormalBidHistory findOneByAccount(Account account) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinList<NormalBidHistory> findListByAccountId(String accountId) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinList<NormalBidHistory> findListByAccount(Account account) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinList<NormalBidHistory> findListByAuctionId(String auctionId) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinList<NormalBidHistory> findListByAuction(NormalAuction auction) throws PersistenceException
  {
  ...
  public NormalBidHistory add(NormalBidHistory bid) throws PersistenceException
  {
   ...
   */
  @Override
  public NormalBidHistory getById(Long id) throws PersistenceException, NotFoundEntityException
  {
   ...
   */
  @Override
  public NormalBidHistory findById(Long id) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinMap<Long, NormalBidHistory> getById(Bid4WinSet<Long> idSet)
   ...
   */
  @Override
  public Bid4WinList<NormalBidHistory> findAll() throws PersistenceException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public NormalBidHistory update(NormalBidHistory bid) throws PersistenceException
  {
  ...
  public NormalBidHistory removeById(Long id) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinSet<NormalBidHistory> removeListById(Bid4WinSet<Long> idSet)
         throws PersistenceException, NotFoundEntityException
  {
   ...
   */
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public Bid4WinSet<NormalBidHistory> removeListByAccount(Account account)
         throws PersistenceException, NotFoundEntityException
  {
    Bid4WinSet<NormalBidHistory> result = new Bid4WinSet<NormalBidHistory>(
        this.findListByAccount(account));
    for(NormalBidHistory bid : result)
    {
   ...
   */
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public Bid4WinSet<NormalBidHistory> removeListByAuction(NormalAuction auction)
         throws PersistenceException, NotFoundEntityException
  {
    Bid4WinSet<NormalBidHistory> result = new Bid4WinSet<NormalBidHistory>(
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public NormalBidHistory remove(NormalBidHistory bid) throws PersistenceException
  {
  ...
  @Override
  @Transactional(readOnly = false)
  public Bid4WinList<NormalBidHistory> removeAll() throws PersistenceException
  {
