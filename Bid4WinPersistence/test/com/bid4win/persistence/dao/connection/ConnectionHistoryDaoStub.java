 ...
 */
@Component("ConnectionHistoryDaoStub")
@Scope("singleton")
@Transactional(readOnly = true, rollbackFor = {Bid4WinException.class})
public class ConnectionHistoryDaoStub
       extends ConnectionHistoryAbstractDao_<ConnectionHistory, Account>
       implements IConnectionHistoryAbstractDaoStub<ConnectionHistory, Account>
{
  /**
   * Constructeur
   */
  protected ConnectionHistoryDaoStub()
  {
   ...
   */
  @Override
  public Bid4WinList<ConnectionHistory> findListByAccountId(String accountId)
         throws PersistenceException
  {
    Bid4WinList<ConnectionHistory> result = super.findListByAccountId(accountId);
   ...
   */
  @Override
  public Bid4WinList<ConnectionHistory> findListByAccount(Account account)
         throws PersistenceException
  {
    Bid4WinList<ConnectionHistory> result = super.findListByAccount(account);
    return Bid4WinEntityLoader.getInstance().loadRelation(result);
  }
  /**
   *
   ...
   */
  @Override
  public ConnectionHistory findOneByAccountId(String accountId) throws PersistenceException
  {
    ConnectionHistory result = super.findOneByAccountId(accountId);
    return Bid4WinEntityLoader.getInstance().loadRelation(result);
  }
  /**
   *
   ...
   */
  @Override
  public ConnectionHistory findOneByAccount(Account account) throws PersistenceException
  {
    ConnectionHistory result = super.findOneByAccount(account);
    return Bid4WinEntityLoader.getInstance().loadRelation(result);
  }
  /**
   *
  ...
  public ConnectionHistory add(ConnectionHistory accountBasedEntity)
         throws PersistenceException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public ConnectionHistory update(ConnectionHistory connection) throws PersistenceException
  {
   ...
   */
  @Override
  public ConnectionHistory getById(Long id) throws PersistenceException
  {
   ...
   */
  @Override
  public ConnectionHistory findById(Long id) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinMap<Long, ConnectionHistory> getById(Bid4WinSet<Long> idSet)
   ...
   */
  @Override
  public Bid4WinList<ConnectionHistory> findAll() throws PersistenceException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public ConnectionHistory removeById(Long id) throws PersistenceException
  {
   ...
   */
  @Override
  public Bid4WinSet<ConnectionHistory> removeListById(Bid4WinSet<Long> idSet)
         throws PersistenceException, NotFoundEntityException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public ConnectionHistory remove(ConnectionHistory accountBasedEntity)
         throws PersistenceException
  {
  ...
  @Override
  @Transactional(readOnly = false, rollbackFor = {Bid4WinException.class})
  public Bid4WinList<ConnectionHistory> removeAll() throws PersistenceException
  {
