...
/**
 * Définition des relations de la classe ImageUsage vers les autres entités<BR>
 * <BR>
...
public class ImageUsage_Relations extends FileResourceUsageMultiPart_Relations
{
  ...
  /** Défini la relation existant avec le produit de l'utilisation d'image */
  public final static Bid4WinRelation RELATION_PRODUCT = new Bid4WinRelation("PRODUCT",
                                                                             Type.SIMPLE);
  /** Défini le noeud de relation existant avec le produit de l'utilisation d'image */
