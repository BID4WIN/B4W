...
/**
 * Définition des relations de la classe CreditInvolvement vers les autres entités<BR>
 * <BR>
...
public class CreditInvolvement_Relations extends AccountBasedEntityMultipleAutoID_Relations
{
  ...
  /** Défini la relation existant avec les utilisations de crédits */
  public final static Bid4WinRelation RELATION_USAGE_MAP = new Bid4WinRelation("USAGE_MAP",
                                                                               Type.MAP);
  /** Défini le noeud de relation existant avec les utilisations de crédits */
