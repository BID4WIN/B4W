...
/**
 * Classe de test du package com.bid4win.persistence.usertype.auction seulement<BR>
 * <BR>
 * @author Emeric Fillâtre
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({com.bid4win.persistence.usertype.auction.StatusUserTypeTest.class})
