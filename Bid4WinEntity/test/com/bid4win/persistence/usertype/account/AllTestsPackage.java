...
/**
 * Classe de test du package com.bid4win.persistence.usertype.account seulement<BR>
 * <BR>
 * @author Emeric Fillâtre
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({com.bid4win.persistence.usertype.account.GenderUserTypeTest.class})
