...
/**
 * Classe de test du package com.bid4win.persistence.entity.price complet<BR>
 * <BR>
 * @author Emeric Fillâtre
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({com.bid4win.persistence.entity.price.AllTestsPackage.class})
