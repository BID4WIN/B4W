...
/**
 * Classe de test du package com.bid4win.persistence.entity.connection complet<BR>
 * <BR>
 * @author Emeric Fillâtre
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({com.bid4win.persistence.entity.connection.AllTestsPackage.class})
