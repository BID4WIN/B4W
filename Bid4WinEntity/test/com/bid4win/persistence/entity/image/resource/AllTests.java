...
/**
 * Classe de test du package com.bid4win.persistence.entity.image.resource complet
 *
 * @author Emeric Fillâtre
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({com.bid4win.persistence.entity.image.resource.AllTestsPackage.class})
