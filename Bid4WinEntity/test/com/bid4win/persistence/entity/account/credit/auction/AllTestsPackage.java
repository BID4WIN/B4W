...
/**
 * Classe de test du package com.bid4win.persistence.entity.account.credit.auction seulement<BR>
 * <BR>
 * @author Emeric Fillâtre
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({com.bid4win.persistence.entity.account.credit.auction.CreditInvolvementNormalTest.class})
