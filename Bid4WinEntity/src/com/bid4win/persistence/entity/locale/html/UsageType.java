...
//
///**
// * Cette classe défini les différents type d'utilisation de page HTML dans l'application<BR>
// * <BR>
...
//
//  /** Utilisation de page HTML simple */
//  public final static UsageType SIMPLE = new UsageType("SIMPLE");
//  /** Utilisation de page HTML pour un produit */
//  public final static UsageType PRODUCT = new UsageType("PRODUCT");
//
//  /** Définition du type d'utilisation de page HTML par défaut */
//  public final static UsageType DEFAULT = Bid4WinObjectType.getDefaultType(UsageType.class);
//
//  /**
//   * Cette méthode permet de récupérer le type d'utilisation de page HTML dont le
//   * code est donné en argument
//   * @param code Code du type d'utilisation de page HTML à récupérer
//   * @return Le type d'utilisation de page HTML correspondant au code en argument
//   * @throws UserException Si le code en argument ne correspond à aucun type d'
//   * utilisation de page HTML connu
//   */
...
//  }
//  /**
//   * Cette méthode permet de récupérer tous les types d'utilisation de page HTML
//   * existants
//   * @return Le set complet de tous les types d'utilisation de page HTML définis
//   */
