...
/**
 * Cette classe défini les différents type d'utilisation d'image dans l'application<BR>
 * <BR>
...
public class UsageType extends Bid4WinObjectType<UsageType>
{
  ...
  /** Définition du type d'utilisation d'image par défaut */
  public final static UsageType DEFAULT = Bid4WinObjectType.getDefaultType(UsageType.class);

  /**
   * Cette méthode permet de récupérer le type d'utilisation d'image dont le code
   * est donné en argument
   * @param code Code du type d'utilisation d'image à récupérer
  ...
  /**
   * Cette méthode permet de récupérer tous les types d'utilisation d'image existants
   * @return Tous les types d'utilisation d'image définis
   */
  public static Bid4WinCollection<UsageType> getUsageTypeSet()
  {
