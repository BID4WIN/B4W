...
public class CreditUsagePrebookedHistory
       extends CreditUsageHistory<CreditUsagePrebookedHistory, CreditInvolvementPrebookedHistory>
{
  /**
   * Constructeur pour création par introspection
   */
  protected CreditUsagePrebookedHistory()
  {
    super();
  }
  /**
   ...
   */
  protected CreditUsagePrebookedHistory(CreditBundleHistory bundle,
                                        CreditInvolvementPrebookedHistory involvement,
                                        int usedNb)
