...
public class PrebookedBid extends Bid<PrebookedBid, PrebookedAuction, PrebookedBidHistory>
{
  /**
   ...
   */
  @Override
  public PrebookedBidHistory toHistory() throws UserException
  {
    return new PrebookedBidHistory(this);
  }
}
